...
def index(req):
    ...
    <div class="container">
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Grifter Rental System!</h1>
        <p class="lead">Grifter's Rental System. A system that will cater borrowing system for in this case MOVIES!!!'.</p>
        <p><a class="btn btn-lg btn-success" href="#" role="button">Visit Us Today</a></p>
      </div>
